...
jest.mock("../components/Tile/Tile", () => ({ value, isCorrect, isPresent }) => (_jsx("div", { "data-testid": "tile", "data-value": value, "data-correct": isCorrect, "data-present": isPresent })));
describe("Grid Component", () => {
    test("renders correct number of rows", () => {
        const guesses = ["apple", "grape"];
        const solution = "apple";
        render(_jsx(Grid, { guesses: guesses, solution: solution }));
    ...
    test('handles incorrect and present letters', () => {
        ...
        const { getAllByTestId } = render(_jsx(Grid, { guesses: guesses, solution: solution }));
